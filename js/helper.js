...
export const capitalizeFirstLetter = (string) => {   //функция помогает сделать первый символ с большой буквы
...
//перерисовка для нового города новой погоды
export const resetWeatherContent = (city, weather) => {
    localStorage.setItem('city', JSON.stringify(city)); //что бы при перезагрузке пользователь оставался по прежнему на погоде своего города
